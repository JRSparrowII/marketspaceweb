...
import { Box, Flex, FormControl, FormErrorMessage, FormLabel, IconButton, 
  Input as ChakraInput, InputProps as ChakraInputProps, InputRightElement } from '@chakra-ui/react';
...
function Input({ label, name, error, register, options, isPassword = false, icon, changeType, ...rest }: InputProps) {
